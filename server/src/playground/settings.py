...
DATABASES = {
    "default": {
        ...
        "HOST": os.environ.get('POSTGRES_API_HOST'),
        "NAME": os.environ.get('POSTGRES_API_NAME'),
        "USER": os.environ.get('POSTGRES_API_USER'),
        "PASSWORD": os.environ.get('POSTGRES_API_PASSWORD')
    }
}
